...
<!-- PROJECT DESCRIPTION -->
# 📖 [About the Project - React Tutorial - To-dos App] <a name="about-project"></a>

**React Tutorial - To-Dos App** It's a simple To-Do list app developed with React. It lets the user add and delete tasks of To-Do activities.
...
```sh
  ...
  git git@github.com:78fatemanazari/react-tutorial.git
```
